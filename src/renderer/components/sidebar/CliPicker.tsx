 ...
 * 사이드바 스크롤 영역 안에서도 잘리지 않도록 fixed 포지셔닝을 사용합니다.
...
export default function CliPicker({
  ...
  useEffect(() => {
    ...
    const handler = (ev: MouseEvent): void => {
      if (wrapRef.current && !wrapRef.current.contains(ev.target as Node)) setMenuPos(null)
    }
  ...
  return (
    <div className="cli-picker" ref={wrapRef}>
      ...
      {menuPos && (
        <div className="cli-picker-dropdown" style={{ top: menuPos.top, left: menuPos.left }}>
